...
ANS- Checked Exception                                      Unchecked Exception
...
ANS- Custom exceptions help represent application-specific errors clearly and make programs easier to understand and maintain.
Real-life Example:
