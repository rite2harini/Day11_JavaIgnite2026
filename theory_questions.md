...
-> Real-life Example:
     -> In a bank application, if a user tries to withdraw more money than available in the account,
                we can create a custom exception called InsufficientBalanceException.
